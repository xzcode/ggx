	...
	public List<ProtoFile> convertToProtoFileList(Doc doc) {
		...
		for (Entry<String, Namespace> entry : namespaces.entrySet()) {
			...
			sb.append(ENTER_LINE).append("//Author : ").append(doc.getAuth()).append(ENTER_LINE)
					...
					.append(ENTER_LINE).append(HEADER_SYNTAX).append(ENTER_LINE).append(ENTER_LINE).append(ENTER_LINE);
			...
			for (Model model : models) {
				...
				sb.append("// ").append(model.getDesc()).append(ENTER_LINE).append("// ").append(actionId)
						.append(ENTER_LINE).append(MODIFIER_MESSAGE).append(" ").append(messageName).append(" {")
						.append(ENTER_LINE);
				...
				for (ModelProperty property : properties) {
					...
					sb.append("  ").append(getFieldProtoModifier(field)).append(" ")
							.append(getFieldProtoDataType(field, doc.getMessageModelPrefix())).append(" ")
							.append(field.getName()).append(" ").append("=").append(" ").append(seq).append(";")
							.append("// ").append(property.getDesc()).append(ENTER_LINE);
