 ...
 * 2020-05-11 12:30:35
 */
public class RouterServiceServerSession  extends AbstractAttrMapSession<GGConfig>{

	/**
	 * 会话组业务服务端会话对象
	 */
	protected GroupServiceServerSession groupServiceServerSession;
	
	public RouterServiceServerSession(GroupServiceServerSession groupServiceServerSession, String sessionId, GGConfig config) {
		super(sessionId, config);
		this.groupServiceServerSession = groupServiceServerSession;
		setReady(true);
	}
	...
	public GGFuture send(Pack pack) {
		return groupServiceServerSession.send(pack);
	}
