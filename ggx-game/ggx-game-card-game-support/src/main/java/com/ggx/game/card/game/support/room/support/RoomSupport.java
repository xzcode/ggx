...
>
extends ExecutorSupport, SendMessageSupport {
	 ...
	 * 2019-12-25 18:52:39
	 */
	default void bcToAllPlayer(Message message) {
		eachPlayer((player) -> {
			player.send(message);
		});
	}
	 ...
	 * 2019-02-23 16:49:17
	 */
	default void bcToAllPlayer(Message message, ICheckCondition<P> condition) {
		eachPlayer((player) -> {
