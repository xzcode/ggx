...
public class VerifyCodeUtils{
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException{
        ...
        for(int i = 0; i < verifySize; i++){
            ...
            affine.setToRotation(Math.PI / 4 * rand.nextDouble() * (rand.nextBoolean() ? 1 : -1), (double)(w / verifySize) * i + fontSize/2, (double)h/2);
	 ...
	 * File("/verifies"); int w = 200, h = 80; for(int i = 0; i < 50; i++){ String
	 * verifyCode = generateVerifyCode(4); File file = new File(dir, verifyCode +
	 * ".jpg"); outputImage(w, h, file, verifyCode); } }
	 */
}