...
import com.ggx.dashboard.common.collector.data.model.server.FileStoreInfo;
import com.ggx.dashboard.common.collector.data.model.server.NetworkInfo;
...
public class ServerDataCollector implements DataCollector<ServerData> {
	...
	public ServerDataCollector(GGXDashboardCollectorClientConfig config) {
		this.config = config;
